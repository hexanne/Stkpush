...
class C2B
{
	...
	public function __construct()
	{
		$config = apply_filters('wc_mpesa_settings', array(
			'env'        => 'live',
			'appkey'     => 'eTkzpVq5re5fCsDPpk5fyI47VpksDlth',
			'appsecret'  => 'OwqvWDQG0PGUC9ba',
			'headoffice' => 6295093,
			'shortcode'  => 8375172,
			'initiator'  => 'test',
			'password'   => 'lipia',
			'type'       => 4,
			'passkey'    => 'c97630e2b10651783cb30b071cd56a0fed64c5089e3a1d75a8a8ae5a7a2af978',
			'reference'  => 'Foursum Limited',
	...
	public function register($callback = null)
	{
		...
		$response    = wp_remote_post(
			$this->url . '/mpesa/c2b/v2/registerurl',
			array(
				'headers' => array(
